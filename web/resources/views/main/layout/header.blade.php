<div class="main-header">
    <div class="logo"><img src="{{ url('img/logop.png') }}" alt="" /></div>
    ...
    <div class="d-flex align-items-center">
        <!-- Mega menu-->
        <div class="dropdown mega-menu d-none d-md-block"><a class="btn text-muted dropdown-toggle mr-3" id="dropdownMegaMenuButton" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pharmacie de garde</a>
            <div class="dropdown-menu text-left" aria-labelledby="dropdownMenuButton">
                <div class="row m-0">
                    <div class="col-md-4 p-4 bg-img">
                        <h2 class="title">Pharmacie de garde <br /> </h2>
                        <p>Quels que soient l’heure et le jour, vous pouvez trouver une pharmacie de garde ouverte en semaine, le dimanche, un jour férié ou la nuit. Le service de garde permet de répondre aux demandes urgentes du public en dehors des heures d’ouverture habituelles des pharmacies. La pharmacie de garde est reconnaissable à sa croix verte qui reste allumée pendant la durée de son service.</p>
                        <button class="btn btn-lg btn-rounded btn-outline-warning">Accueil</button>
                    </div>
                    <div class="col-md-4 p-4">
                        <p class="text-primary text--cap border-bottom-primary d-inline-block">Menu</p>
                        <div class="menu-icon-grid w-auto p-0"><a href="#"><i class="i-Shop-4"></i> Accueil</a></div>
                    </div>
                    {{--  <div class="col-md-4 p-4">
    ...
    <div class="header-part-right">
        ...
        <div class="dropdown"><i class="i-Safe-Box text-muted header-icon" id="dropdownMenuButton" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></i>
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <div class="menu-icon-grid"><a href="#"><i class="i-Shop-4"></i> Accueil</a></div>
            </div>
        </div>
        <!-- Notificaiton-->
        {{-- <div class="dropdown">
        ...
        <div class="dropdown">
             ...
             {{--<div class="user col align-self-end"><img id="userDropdown" src="./assets/images/faces/1.jpgz" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" />
