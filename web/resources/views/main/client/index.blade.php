        ...
        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
            <div class="card-body text-center"><i class="i-Add-User"></i>
                <div class="content">
                    ...
                    <p class="text-primary text-24 line-height-1 mb-2">{{ sizeof($pharmacies) }}</p>
                </div>
            </div>
        </div>
    </div>
...
<div id="propre" class="row">
    ...
    <div class="col-md-6 mb-4">
        <div class="card text-left">
            <div class="card-body">
                <h4 class="card-title mb-3">Liste des communes</h4>
                ...
                <div class="table-responsive">
                    <table class="display table table-striped table-bordered" id="tableau" style="width:100%">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    <td>{{ trim($commune->commune) }}</td>
                                    <td>{{ sizeof($commune->pharmacies) }}</td>
                                    <td> {{ $communes[0]->pharmacies[0]->dateEnd }}  </td>
                                    <td>
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 33px, 0px); top: 0px; left: 0px; will-change: transform;">
                                            <a class="dropdown-item ul-widget__link--font" href="{{ route('communepharm.client',['id'=>$commune->_id,'commune'=>$commune->commune]) }}"><i class="i-Eye"> </i>Afficher</a>
